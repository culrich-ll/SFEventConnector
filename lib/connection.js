...
var org = nforce.createConnection({
  clientId: '<clientIdFromTheConnectedApp>',
  clientSecret: '<clientSecretFromTheConnectedApp>',
  redirectUri: 'http://localhost:3000/token', // as defined in the connected app!
  apiVersion: 'v43.0',  // optional, defaults to current salesforce API version
  environment: 'production',  // optional, salesforce 'sandbox' or 'production', production default
  mode: 'single' // optional, 'single' or 'multi' user mode, multi default
});
var oauth;
org.authenticate({ username: '<username>', password: '<passwordWithToken>' }, function (err, resp) {
